...
#include "hrnetpose/calibrator.h"
#include "hrnetpose/cuda_utils.h"
#include "hrnetpose/utils.h"
...
img_idx_ += batchsize_;
cv::Mat blob = cv::dnn::blobFromImages(input_imgs_, 1.0 / 57.3750, cv::Size(input_w_, input_h_), cv::Scalar(2.155555, 2.026666, 1.80444), true, false);
